    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UName', models.CharField(default='', max_length=10, verbose_name='用户名')),
                ('UPassword', models.CharField(default='', max_length=16, verbose_name='用户密码')),
                ('UEmail', models.EmailField(default='', max_length=254, verbose_name='用户Email')),
                ...
                ('URegDate', models.DateField(auto_now_add=True, verbose_name='注册时间')),
                ('ULastOnlineDate', models.DateField(blank=True, null=True, verbose_name='用户最后上线时间')),
                ...
                ('UIfAdmin', models.BooleanField(default=False, verbose_name='是否管理员')),
            ],
        ),
        migrations.CreateModel(
            name='CompRecord',
            fields=[
                ...
                ('RPromulgatorID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.UserMessage', verbose_name='发布者编号')),
            ],
        ),
        migrations.CreateModel(
            name='BBSTopic',
