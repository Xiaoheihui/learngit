# Generated by Django 2.2.4 on 2019-09-25 07:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CompLevel',
            fields=[
                ('ID', models.AutoField(primary_key=True, serialize=False, verbose_name='赛事等级编号')),
                ('Name', models.CharField(default='', max_length=5, verbose_name='赛事等级名字')),
                ('Statement', models.CharField(max_length=100, null=True, verbose_name='赛事等级说明')),
            ],
        ),
        migrations.CreateModel(
            name='CompRecord',
        ...
        migrations.AddField(
            model_name='compinfo',
            name='ILevel',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.CompLevel', verbose_name='赛事等级编号'),
        ),
        migrations.CreateModel(
            name='BBSTopic',
            fields=[
